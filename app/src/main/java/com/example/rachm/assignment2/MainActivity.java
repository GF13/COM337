...
public class MainActivity extends ActionBarActivity {
    DatabaseHelper myDb;
    EditText editName,editBreed,editAge ,editID;
    Button btnAddData;
    Button btnviewAll;
    Button btnDelete;
                ...
                new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        boolean isUpdate = myDb.updateData(editID.getText().toString(),
                                ...
                                editBreed.getText().toString(),editAge.getText().toString());
                        if(isUpdate == true)
                ...
                new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        while (res.moveToNext()) {
                            ...
                            buffer.append("Breed :"+ res.getString(2)+"\n");
                            buffer.append("Age :"+ res.getString(3)+"\n\n");
                        }

                        // Show all data
                        showMessage("Dogs",buffer.toString());
                    }
                }
        );
    }
